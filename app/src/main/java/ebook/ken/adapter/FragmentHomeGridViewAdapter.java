...
public class FragmentHomeGridViewAdapter extends BaseAdapter {
	...
	public static void setmLocations(List<BookOffline> mLocations) {
		FragmentHomeGridViewAdapter.mLocations = mLocations;
	}


	public FragmentHomeGridViewAdapter(Context context, List<BookOffline> locations) {
